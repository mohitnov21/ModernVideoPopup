...
import comi.example.modern.modernvideopopup.widget.MovieView;
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        ...
                        0);
        final Icon icon = Icon.createWithResource(popupActivity.this, iconId);
        actions.add(new RemoteAction(icon, title, title, intent));

        // Another action item. This is a fixed action.
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(popupActivity.this, R.drawable.ic_info_24dp),
